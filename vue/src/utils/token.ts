/**
 * Pure JWT helpers used to gate protected admin UI on the client.
 *
 ...
 * a stale admin session before the dashboard is ever painted, instead of
 * optimistically rendering it and only discovering the 401 after a network
 * round-trip (the flash-of-dashboard bug — the fe-admin counterpart of the
 * fe-user fix, sprint 2026-05-23/01).
 *
