...
/**
 * Production smoke test for the admin plugin loader.
 *
 ...
 */
test.describe('admin plugins load cleanly in production', () => {
  test('/admin/ has no fatal JS errors and fetches plugins.json', async ({ page }) => {
