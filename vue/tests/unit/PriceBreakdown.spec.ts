/**
 * S85.4 (fe-admin) — shared <PriceBreakdown> detailed tax-disclosure component.
 *
 * The expanded price disclosure for financial surfaces (admin invoices): the
 * net line, one line per tax rate straight from ``Price.taxes`` labelled by the
 * human-readable tax NAME (e.g. "VAT Germany 19% — €X"), and the gross total. It
 * performs NO tax arithmetic and formats via fe-core ``formatMoney``. There is
 * no redundant Σtax row.
 */
